    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="text-sm self-center font-semibold">
          {fileUploadError ? 
        (<span className="text-red-700">Error Image upload (image must b less than 2 mb)</span> ) :
      filePerc > 0 && filePerc < 100 ? (
        ...
        rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-85 font-semibold
      ...
      <div className="flex justify-between mt-5">
        <span onClick={handleDeleteUser} className="text-red-700 cursor-pointer
         font-semibold hover:underline">Delete account</span>
        <span onClick={handleSignOut} className="text-red-700 cursor-pointer
         font-semibold hover:underline">Sign out</span>
      </div>
